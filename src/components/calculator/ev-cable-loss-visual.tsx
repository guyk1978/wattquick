  ...
  return (
    ...
    >
      <div className={cn(flatVisualPanel, "rounded-none p-4")}>
        <div className="relative mx-auto h-28 w-full max-w-[120px] overflow-hidden rounded-none bg-orange-950/25 dark:bg-orange-950/60">
          <div
        ...
        <div className="mt-3 flex items-center justify-center gap-2 rounded-none border border-amber-500/25 bg-amber-500/10 px-3 py-2">
          <Zap
