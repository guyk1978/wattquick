...
If the room is a far garage or addition, also run [Residential Voltage Drop](/residential-voltage-drop/)—low voltage at the last can mimics “bad LEDs.”
...
- [Lighting Circuit Load Guide](/blog/lighting-circuit-load-guide/) — methodology  
- [80% Continuous Load Rule](/blog/lighting-circuit-80-percent-rule/) — why the limit exists  
