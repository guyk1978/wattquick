...
<CalculatorEmbed slug="peak-shaving-potential" />

## Operational decisions for the home schedule

Use the [Peak Shaving Potential Calculator](/peak-shaving-potential/) as a **monthly ops board**:
...
Commercial sites add demand kW—homes usually start with energy TOU. Graduate to [Demand Charge Calculator](/demand-charge-calculator/) if you run a shop on the same meter.
