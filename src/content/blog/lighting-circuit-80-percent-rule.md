...
1. **Split circuits** — new homerun to panel for heavy kitchen or outdoor zones  
2. **Reduce load** — lower-watt luminaires or shorter tape runs  
3. **Upsize breaker only with upsized wire** — never swap 15 A → 20 A on #14 copper  

<CalculatorEmbed slug="lighting-circuit-load" />

## Related reading

- [Lighting Circuit Load Guide](/blog/lighting-circuit-load-guide/) — full workflow  
- [Home Lighting Safety Check](/blog/home-lighting-circuit-safety/) — remodel self-check  
