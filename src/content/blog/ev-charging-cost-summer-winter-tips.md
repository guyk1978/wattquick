...
<CalculatorEmbed slug="ev-preconditioning-cost" />
...
Pair with [EV Winter Range Loss](/ev-winter-range-loss/) for driving-season planning and [EV Charging Cost](/ev-charging-cost/) for delivered-energy bills.

## When pre-conditioning is worth it

| Scenario | Usually worth it? |
| --- | --- |
| DC fast charge in freezing weather | Yes — restores charge speed |
| Level 2 overnight in mild weather | Often automatic, low kW |
| Summer DC after highway drive | Yes if station shows reduced kW until cooled |
| Short Level 2 top-up | Minimal thermal cost |
