...
Treat the [Solar Water Heater Efficiency Calculator](/solar-water-heater-efficiency/) like a seasonal blood test:

1. **Baseline** after commissioning on a clear week—record efficiency %, water kWh, and savings vs. electric.  
2. **Quarterly** rerun with the same tank volume and aperture; only sun hours and ΔT change with season.  
3. **Alert thresholds:** &gt; 15% drop in efficiency with similar sun hours → schedule service.  
