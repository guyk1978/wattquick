...
/**
 * Calculator share cards are VIZ (Data Flow) preview frames generated by
 * `npm run generate:share-images` into `/images/share/{slug}.webp`.
 */
export const CALCULATOR_SHARE_OG_WIDTH = 1200;
export const CALCULATOR_SHARE_OG_HEIGHT = 630;
