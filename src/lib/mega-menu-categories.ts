...
export const MEGA_MENU_CATEGORIES: MegaMenuCategory[] = [
  {
    ...
    href: getCategoryPageHref("solar"),
    icon: Sun,
    color: "#F59E0B",
  },
  {
  ...
  },
  {
    ...
    href: getCategoryPageHref("ebike"),
    icon: Bike,
    color: "#22D3EE",
  },
  {
    ...
    href: getCategoryPageHref("escooter"),
    icon: Footprints,
    color: "#F472B6",
  },
  {
    ...
    href: getCategoryPageHref("battery"),
    icon: Battery,
    color: "#22C55E",
  },
  {
    ...
    href: getCategoryPageHref("appliance"),
    icon: Zap,
    color: "#F97316",
  },
  {
  ...
  },
  {
    ...
    href: getCategoryPageHref("power"),
    icon: Zap,
    color: "#A855F7",
  },
  {
    ...
    href: getCategoryPageHref("convert"),
    icon: ArrowLeftRight,
    color: "#06B6D4",
  },
  {
    ...
    href: getCategoryPageHref("backup"),
    icon: Shield,
    color: "#EF4444",
  },
  {
    ...
    href: getCategoryPageHref("sizing"),
    icon: Gauge,
    color: "#10B981",
  },
  {
    ...
    href: getCategoryPageHref("green-home"),
    icon: Leaf,
    color: "#84CC16",
  },
  {
    category: "tou",
    label: CALCULATOR_CATEGORY_LABELS.tou,
    description: CALCULATOR_CATEGORY_DESCRIPTIONS.tou,
    href: getCategoryPageHref("tou"),
    icon: Clock,
    color: "#8B5CF6",
  },
  {
    ...
    href: getCategoryPageHref("commercial-ev"),
    icon: Car,
    color: "#2563EB",
  },
  {
    ...
    href: getCategoryPageHref("rv-marine"),
    icon: Ship,
    color: "#0EA5E9",
  },
];
